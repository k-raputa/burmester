import template from './sw-cms-el-udg-download.html.twig';
import './sw-cms-el-udg-download.scss';

const { Component, Mixin } = Shopware;

Component.register('sw-cms-el-udg-download', {
    template,
    ...
    methods: {
        createdComponent() {
            this.initElementConfig('udg-download');
            this.initElementData('udg-download');
        }
    }
});
