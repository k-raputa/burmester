...
namespace UdgDownloadCmsElement\Content\Media\Cms;
...
use UdgDownloadCmsElement\Content\Cms\SalesChannel\Struct\MediaStruct;

class DownloadCmsElementResolver extends AbstractCmsElementResolver
{
    ...
    private function addMediaEntity(CmsSlotEntity $slot, MediaStruct $image, ElementDataCollection $result, FieldConfig $config, ResolverContext $resolverContext): void
    {
