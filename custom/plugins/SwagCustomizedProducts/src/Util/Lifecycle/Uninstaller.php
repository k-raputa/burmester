...
class Uninstaller
{
    ...
    private function removeTemplateTables(): void
    {
        ...
        $this->connection->executeUpdate('DROP TABLE IF EXISTS `swag_customized_products_template_configuration_share`;');
        $this->connection->executeUpdate('DROP TABLE IF EXISTS `swag_customized_products_template_configuration`;');
