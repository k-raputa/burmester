...
class CustomizedProductsCartDataCollector implements CartDataCollectorInterface
{
    ...
    public const CUSTOMIZED_PRODUCT_CONFIGURATION_KEY = 'customizedProductConfiguration';
    ...
    public function __construct(
        ...
        TemplateConfigurationServiceInterface $templateConfigurationService
    ) {
    ...
    public function collect(
        ...
        foreach ($customizedProductsLineItems as $customizedProductsLineItem) {
            ...
            $this->addConfigurationExtension($customizedProductsLineItem, $original, $salesChannelContext);
        }
    }
