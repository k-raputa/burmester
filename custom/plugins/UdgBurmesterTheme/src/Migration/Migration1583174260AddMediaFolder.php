...
class Migration1583174260AddMediaFolder extends MigrationStep
{
...
VALUES (:id, '["udgBurmesterThemeDemoDownloads"]', 'udg_burmester_theme_demo_downloads', :createdAt);
SQL;
...
VALUES (:folderId, 'Burmester Theme Demo Downloads', :defaultFolderId, :configurationId, 0, 0, :createdAt);
SQL;
