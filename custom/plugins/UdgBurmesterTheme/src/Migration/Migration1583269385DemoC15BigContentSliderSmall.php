...
class Migration1583269385DemoC15BigContentSliderSmall extends MigrationStep
{
    ...
    {
        $pageTree = '99.2.12';
        $pageName = '(C15.01): Big-Content-Slider - small';
        ...
        C15BigContentSliderSmall::createSection(
            $connection,
            $cmsPageId,
