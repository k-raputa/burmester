...
class C03BigVideoWithPreviewVideoAutoplay implements ContentSectionInterface
{
    ...
    public static function createSection(Connection $connection, string $cmsPageId, string $cmsBaseId, int $position = 0)
    {
        ...
        $cmsSectionId = CmsSection::createCmsSection(
            ...
            [
                ...
                'cms_section_name' => 'C03BigVideoWithPreviewVideoAutoplay',
                'position' => $position,
            ]
        );
            ...
            [
                ...
                'cmsSlots' => [
                    ...
                    [
                        ...
                        'type' => 'youtube-video',
                        'slot' => 'videodesktop',
                        'en_config' => '{"end": {"value": null, "source": "static"}, "loop": {"value": true, "source": "static"}, "start": {"value": null, "source": "static"}, "videoID": {"value": "kg2fwlFsZss", "source": "static"}, "autoPlay": {"value": false, "source": "static"}, "displayMode": {"value": "standard", "source": "static"}, "showControls": {"value": false, "source": "static"}, "advancedPrivacyMode": {"value": false, "source": "static"}}',
                        'en_custom_fields' => '{}',
                    ],
                    [
                        ...
                        'type' => 'youtube-video',
                        'slot' => 'videomobile',
                        'en_config' => '{"end": {"value": null, "source": "static"}, "loop": {"value": false, "source": "static"}, "start": {"value": null, "source": "static"}, "videoID": {"value": "kg2fwlFsZss", "source": "static"}, "autoPlay": {"value": false, "source": "static"}, "displayMode": {"value": "standard", "source": "static"}, "showControls": {"value": false, "source": "static"}, "advancedPrivacyMode": {"value": false, "source": "static"}}',
                        'en_custom_fields' => '{}',
                    ],
                ]
            ]
