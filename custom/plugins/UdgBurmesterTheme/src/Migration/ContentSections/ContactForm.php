...
class ContactForm implements ContentSectionInterface
{
            ...
            [
                ...
                'cmsSlots' => [
                    [
                        ...
                        'type' => 'form',
                        'slot' => 'content',
                        'en_config' => '{"type": {"value": "contact", "source": "static"}, "title": {"value": "", "source": "static"}, "mailReceiver": {"value": ["doNotReply@localhost"], "source": "static"}, "confirmationText": {"value": "Lorem ipsum dolor sit amet, consetetur sadipscing elitr.", "source": "static"}, "defaultMailReceiver": {"value": true, "source": "static"}}',
                        'en_custom_fields' => '{}',
                    ],
                ]
            ]
