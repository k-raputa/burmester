...
class C02ImageOverlappingTextRight implements ContentSectionInterface
{
    ...
    public static function createSection(Connection $connection, string $cmsPageId, string $cmsBaseId, int $position = 0)
    {
        ...
        $cmsSectionId = CmsSection::createCmsSection(
            ...
            [
                ...
                'cms_section_name' => 'C02ImageOverlappingTextRight',
                'position' => $position,
            ]
        );
        ...
        CmsSection::createCmsBlockWithElements(
            ...
            [
                'cmsBlock' => [
                    ...
                    'type' => 'image-text',
                    'name' => '',
                    'css_class'   => 'col-12 image-video-container image-overlapping ',
                    'margin_bottom' => '0',
                ],
                'cmsSlots' => [
                    [
