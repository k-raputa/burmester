...
class C02ImageTextLeft implements ContentSectionInterface
{
    ...
    public static function createSection(Connection $connection, string $cmsPageId, string $cmsBaseId, int $position = 0)
    {
        ...
        $cmsSectionId = CmsSection::createCmsSection(
            ...
            [
                ...
                'css_class'   => 'component-image-text-video theme-mine-shaft',
                'sizing_mode' => 'boxed',
                'cms_section_id' => substr($cmsBaseId, 0, 10) . '-' . $position,
                'cms_section_name' => 'C02ImageTextLeft',
                'position' => $position,
            ]
        );
        ...
        CmsSection::createCmsBlockWithElements(
            ...
            [
                'cmsBlock' => [
                    ...
                    'type' => 'image-text',
                    'name' => '',
                    'css_class'   => 'col-12 image-video-container',
                    'margin_bottom' => '0',
                ],
                'cmsSlots' => [
                    [
